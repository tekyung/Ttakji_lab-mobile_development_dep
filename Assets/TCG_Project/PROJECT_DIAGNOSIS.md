> ## 📌 이 문서는 과거 기록입니다 (2026-03-02 작성)
>
> Phase 12 직후의 **로직 레이어** 진단서입니다. 그 뒤로 Phase 13~18, 매치 시작 DI,
> Unity 보드 UI, 온라인 대전이 추가되어 **현재 코드와 다른 서술이 많습니다.**
> 당시 판단 근거를 참고할 때만 읽고, 최신 사실은 아래에서 확인하세요.
>
> - 현재 상태·남은 일 → 루트 `README.md`
> - 상세 인수인계 → `Assets/TCG_Project/HANDOFF.md`
